const carrerList = [
  ...
  { name: "Good Communication", lookup_type: "Soft_skills" },
  { name: "Good Persuasive power", lookup_type: "Soft_skills" },
  { name: "Responsible", lookup_type: "Soft_skills" },
  { name: "Resilience", lookup_type: "Soft_skills" },
  { name: "Team Player", lookup_type: "Soft_skills" },
  { name: "Analytical Ability", lookup_type: "Soft_skills" },
  { name: "Disciplined", lookup_type: "Soft_skills" },
  { name: "Good Listening", lookup_type: "Soft_skills" },
  { name: "Ability To Influence", lookup_type: "Soft_skills" },
  { name: "Trustworthy", lookup_type: "Soft_skills" },
  { name: "Patience", lookup_type: "Soft_skills" },
  { name: "Flexibility", lookup_type: "Soft_skills" },
  { name: "Leadership", lookup_type: "Soft_skills" },
  { name: "Self Motivated", lookup_type: "Soft_skills" },
  { name: "Humility", lookup_type: "Soft_skills" },
  { name: "Time Management", lookup_type: "Soft_skills" },
  { name: "Professionalism", lookup_type: "Soft_skills" },
  { name: "Ethical", lookup_type: "Soft_skills" },
  { name: "Integrity", lookup_type: "Soft_skills" },
];
